...
const Map<String, Map<String, String>> _localizedValues =
  ...
  "en": <String, String>{
    ...
    "presets.coherent_5_5": "Coherent 5.5-5.5",
  ...
  "es": <String, String>{
    ...
    "presets.coherent_5_5": "Coherente 5.5-5.5",
  ...
  "de": <String, String>{
    ...
    "presets.coherent_5_5": "Koherent 5.5-5.5",
  ...
  "pt": <String, String>{
    ...
    "presets.coherent_5_5": "Coerente 5.5-5.5",
  ...
  "ru": <String, String>{
    ...
    "presets.coherent_5_5": "Сбалансированный 5.5-5.5",
  ...
  "uk": <String, String>{
    ...
    "presets.coherent_5_5": "Збалансоване 5.5-5.5",
    "presets.resonant_6_6": "Резонанс 6-6",
  ...
  "hi": <String, String>{
    ...
    "presets.coherent_5_5": "कोहेरेंट 5.5-5.5",
  ...
  "ja": <String, String>{
    ...
    "presets.coherent_5_5": "コヒーレント 5.5-5.5",
  ...
  "pl": <String, String>{
    ...
    "presets.coherent_5_5": "Spojny 5.5-5.5",
